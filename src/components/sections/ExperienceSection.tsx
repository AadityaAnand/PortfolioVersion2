  ...
  return (
    <section id="experience" className="section-padding">
      <div className="shell-container space-y-10">
        <SectionHeading
          eyebrow="Experience"
          title="Work told as problem stories."
          copy="Not a bullet dump. The point here is how I reason through constraints, decide what matters, and ship systems that people can actually use."
        />
              ...
              <GlassPanel className="p-6 md:p-7">
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  <div className="space-y-3">
                    ...
                    <div>
                      <h3 className="font-display text-2xl text-white">{experience.role}</h3>
                      <p className="mt-1 text-white/55">
                        {experience.company} · {experience.location}
                      </p>
                    </div>
                    <p className="max-w-3xl text-base leading-7 text-white/70">{experience.summary}</p>
                  </div>
                ...
                <details className="group mt-6 rounded-[24px] border border-white/10 bg-black/20 px-5 py-4">
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-sm text-white/70">
                    <span>Open full problem story</span>
